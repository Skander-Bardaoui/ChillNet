...
<select id="urgence" name="urgence" class="rounded-lg bg-surface-container-high text-on-surface px-space-sm py-2 focus:outline-none"><option>Normale</option><option>Prioritaire</option><option>Vitale — appeler le 190</option></select>
</div>
...
<a href="tel:190" class="inline-flex items-center gap-1 font-label-md text-label-md text-error hover:underline"><span class="material-symbols-outlined text-[16px]">emergency</span>Situation vitale ? Appelez le 190</a>
</div>
</form>
</section>
...
<thead><tr class="font-label-sm text-label-sm uppercase text-on-surface-variant border-b border-surface-variant"><th scope="col" class="py-2 pr-4">Objet</th><th scope="col" class="py-2 pr-4">Catégorie</th><th scope="col" class="py-2 pr-4">Urgence</th><th scope="col" class="py-2 pr-4">Statut</th><th scope="col" class="py-2">Date</th></tr></thead>
...
<tr class="border-b border-surface-variant"><td class="py-2 pr-4">Fontaine place du Marché en panne</td><td class="py-2 pr-4">Point d'eau</td><td class="py-2 pr-4">Normale</td><td class="py-2 pr-4"><span class="px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 font-label-sm text-label-sm">En traitement</span></td><td class="py-2">22/09/2026</td></tr>
...
<div class="mt-space-sm flex items-center gap-2 font-body-sm text-body-sm text-on-surface-variant"><span class="material-symbols-outlined text-[16px] text-primary">info</span><span>Urgence vitale ? Appelez directement le <a href="tel:190" class="text-primary font-semibold hover:underline">190</a> ou la plateforme <a href="tel:0800066666" class="text-primary font-semibold hover:underline">0800 06 66 66</a>.</span></div>
</section>
</x-app-layout>
