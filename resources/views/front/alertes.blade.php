...
<h1 class="sr-only">Alertes canicule en cours</h1>
...
<div class="relative flex items-center justify-center w-12 h-12 rounded-xl bg-red-100 text-red-800 shrink-0">
...
<span class="px-2 py-0.5 rounded-full bg-red-100 text-red-800 font-label-sm text-label-sm tracking-wider uppercase font-semibold">Vigilance rouge canicule</span>
...
<a href="tel:190" class="flex-1 lg:flex-initial px-space-md py-2.5 rounded-lg bg-red-600 text-white font-label-md text-label-md font-semibold hover:opacity-95 shadow-md flex items-center justify-center gap-2"><span class="material-symbols-outlined text-[18px]">emergency</span><span>Urgence : 190</span></a>
</div>
</div>
</section>
...
<span class="px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 font-label-sm text-label-sm uppercase tracking-wider font-semibold flex items-center gap-1"><span class="material-symbols-outlined text-[14px]">thermostat</span>Vigilance jaune</span>
...
<article class="rounded-xl bg-surface-container-low p-space-md shadow-md flex flex-col gap-space-sm">
<div class="flex items-center justify-between">
<span class="px-2 py-0.5 rounded-full bg-orange-100 text-orange-800 font-label-sm text-label-sm uppercase tracking-wider font-semibold flex items-center gap-1"><span class="material-symbols-outlined text-[14px]">wb_sunny</span>Vigilance orange</span>
...
<div class="flex items-center gap-2 pt-1"><a href="#conseils-orange" class="text-primary font-label-md text-label-md hover:underline">Voir les réflexes</a><a href="tel:190" class="ml-auto inline-flex items-center gap-1 font-label-md text-label-md text-on-surface-variant hover:text-primary"><span class="material-symbols-outlined text-[16px]">call</span>Urgence 190</a></div>
</article>
<article class="rounded-xl bg-surface-container-low p-space-md shadow-md flex flex-col gap-space-sm border border-error/30">
<div class="flex items-center justify-between">
<span class="px-2 py-0.5 rounded-full bg-red-100 text-red-800 font-label-sm text-label-sm uppercase tracking-wider font-semibold flex items-center gap-1"><span class="material-symbols-outlined text-[14px]">warning</span>Vigilance rouge</span>
...
<div class="flex items-center gap-2 pt-1"><a href="#conseils-rouge" class="text-primary font-label-md text-label-md hover:underline">Voir les réflexes</a><a href="tel:190" class="ml-auto inline-flex items-center gap-1 font-label-md text-label-md text-error hover:underline"><span class="material-symbols-outlined text-[16px]">emergency</span>Appeler le 190</a></div>
</article>
</section>
