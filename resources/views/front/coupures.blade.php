...
<img src="https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1600&q=80" alt="Réseau électrique au crépuscule" class="w-full h-56 md:h-72 object-cover saturate-50 contrast-125 brightness-50" />
...
<div class="px-space-sm py-1.5 rounded-lg bg-surface-container-lowest/90 backdrop-blur-md font-body-sm text-body-sm text-on-surface flex items-center gap-2"><span class="material-symbols-outlined text-[18px] text-tertiary-container">bolt</span>Charge réseau : <strong class="text-tertiary">84%</strong> (stable)</div>
...
<div class="p-2 rounded-lg bg-error/15 text-error self-start"><span class="material-symbols-outlined text-[20px]">power_off</span></div>
<div class="flex-1">
<div class="flex items-center gap-2 flex-wrap"><h2 class="font-title-md text-title-md text-on-surface">Délestage — Faubourg Nord</h2><span class="px-2 py-0.5 rounded-full bg-error/15 text-error font-label-sm text-label-sm uppercase">En cours</span></div>
...
<article class="rounded-xl bg-surface-container-low p-space-md shadow-sm flex flex-col md:flex-row md:items-center gap-space-sm">
<div class="p-2 rounded-lg bg-tertiary-container/15 text-tertiary self-start"><span class="material-symbols-outlined text-[20px]">construction</span></div>
<div class="flex-1">
<div class="flex items-center gap-2 flex-wrap"><h2 class="font-title-md text-title-md text-on-surface">Panne — Berges Sud</h2><span class="px-2 py-0.5 rounded-full bg-tertiary-container/20 text-tertiary font-label-sm text-label-sm uppercase">Prévue</span></div>
...
<a href="tel:15" class="inline-flex items-center gap-1 font-label-md text-label-md text-on-surface-variant hover:text-primary"><span class="material-symbols-outlined text-[16px]">emergency</span>Urgence : 15</a>
</div>
</form>
</section>
</x-public-layout>
