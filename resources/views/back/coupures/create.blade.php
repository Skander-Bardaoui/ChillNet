...
<input type="text" id="zone" name="zone" value="Menzah 1 — Secteur Nord" class="w-full rounded-lg bg-surface-container border border-outline-variant/40 px-3 py-2.5 text-on-surface focus:border-primary-container focus:outline-none" />
</div>
...
<option selected>Délestage</option>
...
<input type="datetime-local" id="debut" name="debut" value="2026-08-12T14:00" class="w-full rounded-lg bg-surface-container border border-outline-variant/40 px-3 py-2.5 text-on-surface focus:border-primary-container focus:outline-none" />
</div>
<div class="flex flex-col gap-2">
<label for="fin" class="font-label-md text-label-md text-on-surface">Fin</label>
<input type="datetime-local" id="fin" name="fin" value="2026-08-12T17:00" class="w-full rounded-lg bg-surface-container border border-outline-variant/40 px-3 py-2.5 text-on-surface focus:border-primary-container focus:outline-none" />
</div>
</div>
<div class="mt-4 flex flex-col gap-2">
<label for="message" class="font-label-md text-label-md text-on-surface">Message</label>
<textarea id="message" name="message" rows="4" class="w-full rounded-lg bg-surface-container border border-outline-variant/40 px-3 py-2.5 text-on-surface focus:border-primary-container focus:outline-none">Coupure programmée pour délestage, prévoyez vos équipements sensibles.</textarea>
</div>
